...
static struct onvm_prof_counter onvm_prof_last[RTE_MAX_LCORE][ONVM_PROF_KEY_COUNT];
...
onvm_prof_log_periodic(void) {
        ...
        if (onvm_prof_log_fp == NULL) {
                ...
                fprintf(onvm_prof_log_fp,
                        "timestamp,lcore,key,calls_delta,cycles_delta,avg_cycles_delta,"
        ...
        for (lcore_id = 0; lcore_id < RTE_MAX_LCORE; lcore_id++) {
                for (key = 0; key < ONVM_PROF_KEY_COUNT; key++) {
                        ...
                        cur.calls = onvm_prof_stats->counters[lcore_id][key].calls;
                        cur.cycles_total = onvm_prof_stats->counters[lcore_id][key].cycles_total;
                        cur.cycles_min = onvm_prof_stats->counters[lcore_id][key].cycles_min;
                        cur.cycles_max = onvm_prof_stats->counters[lcore_id][key].cycles_max;

                        last = &onvm_prof_last[lcore_id][key];
                        ...
                        fprintf(onvm_prof_log_fp,
                                ...
                                ",%" PRIu64 "\n",
                                time_buf, lcore_id, onvm_prof_key_names[key], calls_delta, cycles_delta,
